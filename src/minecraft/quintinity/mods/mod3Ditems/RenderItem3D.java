...
public class RenderItem3D extends RenderItem
{
    ...
    public void renderItem(EntityItem par1EntityItem, double par2, double par4, double par6, float par8, float par9)
    {
            ...
            else
            {
                ...
                if (var10.getItem().requiresMultipleRenderPasses())
                {
                    ...
                    else
                    {
                        ...
                        GL11.glTranslatef(0F, (float)((itemScale - 1) * 0.3), 0F);
                    }
                    ...
                    for (var15 = 0; var15 <= var10.getItem().getRenderPasses(var10.getItemDamage()); ++var15)
                    {
                        ...
                        if (this.field_77024_a)
                        {
                            ...
                            //RenderHelper3D.renderWithOverlay(var16, 0, par1EntityItem.func_92014_d(), random, RenderHelper3D.getTextureWidth());
                ...
                else
                {
                    ...
                    if (this.field_77024_a)
                    {
                        ...
                        var20 = 1.0F;
                        //RenderHelper3D.renderWithOverlay(var15, 0, par1EntityItem.func_92014_d(), random, RenderHelper3D.getTextureWidth());
    ...
    private void func_77020_a(EntityItem par1EntityItem, int par2, int par3, float par4, float par5, float par6, float par7)
    {
        ...
        if (Settings.getRenderIn3D())
        {
            ...
            {
            	float angle = (((float)par1EntityItem.age + par4) / 20.0F + par1EntityItem.hoverStart) * (180F / (float)Math.PI);
            	if (!Settings.getItemRotation()) {angle = 0;}
    ...
    {
        this.renderItem((EntityItem)par1Entity, par2, par4, par6, par8, par9);
    }
